...
function probedemo_loopLoopBegin(probedemo_loopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    probedemo_loop.forEach(function() {
...
function TrainExpswitchLoopBegin(TrainExpswitchLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    TrainExpswitch.forEach(function() {
...
function DistCalibrationRoutineBegin(snapshot) {
  return async function () {
    ...
    DistCalibrationComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ShowDistanceRoutineBegin(snapshot) {
  return async function () {
    ...
    ShowDistanceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function moviedemoRoutineBegin(snapshot) {
  return async function () {
    ...
    moviedemoComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function probeexplainRoutineBegin(snapshot) {
  return async function () {
    ...
    probeexplainComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ProbedefineRoutineBegin(snapshot) {
  return async function () {
    ...
    ProbedefineComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function precuedemoRoutineBegin(snapshot) {
  return async function () {
    ...
    precuedemoComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function probedemoRoutineBegin(snapshot) {
  return async function () {
    ...
    probedemoComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function responseexplainRoutineBegin(snapshot) {
  return async function () {
    ...
    responseexplainComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function moviestartRoutineBegin(snapshot) {
  return async function () {
    ...
    moviestartComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function moviedefineRoutineBegin(snapshot) {
  return async function () {
    ...
    moviedefineComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function precueRoutineBegin(snapshot) {
  return async function () {
    ...
    precueComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function movieRoutineBegin(snapshot) {
  return async function () {
    ...
    movieComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function endthankRoutineBegin(snapshot) {
  return async function () {
    ...
    endthankComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
